    ...
    Column(
        ...
        q.options.forEachIndexed { index, option ->
            ...
            ElevatedCard(
                ...
                elevation = CardDefaults.elevatedCardElevation(defaultElevation = if (isSelected) 8.dp else 1.dp)
            ) {
        ...
        if (state.feedback == null) {
            ...
            val label = if (state.isLastQuestion || state.lives <= 0) "Ver resultados" else "Siguiente"
